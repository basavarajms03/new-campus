...
<body>
    ...
    <div class="mt-5 col-md-4 container">
        <form action="college_add_jobs_success.php" method="post">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="companyId">Company ID</label>
                        <input type="text" class="form-control" name="companyId" id="companyId" aria-describedby="helpId" placeholder="Enter company ID">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="companyName">Company Name</label>
                        <input type="text" class="form-control" name="companyName" id="companyName" aria-describedby="helpId" placeholder="Enter company name">
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="test">do you want to take test?</label>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="Gmarks">Metric</label>
                        <input type="text" class="form-control" name="Gmarks" id="Gmarks" aria-describedby="helpId" placeholder="Metric">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="Pmarks">PUC/Dip</label>
                        <input type="text" class="form-control" name="Pmarks" id="Pmarks" aria-describedby="helpId" placeholder="PUC/Diploma">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="Hmarks">Graduation</label>
                        <input type="text" class="form-control" name="Hmarks" id="Hmarks" aria-describedby="helpId" placeholder="Graduation" readonly>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="date" id="date" aria-describedby="helpId" placeholder="Enter Hiring Date">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
