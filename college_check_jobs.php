    ...
    <table class="table table-striped w-100">
        ...
        <tbody>
            ...
            while ($row = mysql_fetch_array($result)) {
                ...
                echo $row[6] . "/-";
                echo "</td><td>";
                echo "<a href='college_jobs_more_description.php?id=$row[3]&companyId=$row[2]'>More Info</a>";
                echo "</td><td>";
                echo "<a href='college_shortlisted_students.php?id=$row[3]&companyId=$row[2]'>Shortlisted Students</a>";
            }
            ?>
        </tbody>
    </table>