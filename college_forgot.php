...
<head>
    ...
    <title>College Forgot Password</title>
</head>

<body>

    <div class="container col-md-4 offset-md-4 mt-5">
        <h4 class="text-center">College Forgot Password</h4>
        <form action="college_forgot_success.php" method="post" class="mt-5" autocomplete="off">
